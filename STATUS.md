...
- Phase 24 frontend merged through PR #35 and Phase 24 backend support merged through PR #34.
...
- Branch: `frontend/phase-25-player-room`, rebased directly onto current `origin/main`.
...
- Phase 29 local/Google Drive media remains separately gated and is not part of this UI branch.
