...
const media: MediaPlatformBridge = {
  ...
  listDriveWorkspace: (options) => window.nightwatch.media.listDriveWorkspace(options),
  createDriveWorkspaceFolder: (name, parentId) => window.nightwatch.media.createDriveWorkspaceFolder(name, parentId),
  authorizeDriveWorkspaceFolder: () => window.nightwatch.media.authorizeDriveWorkspaceFolder(),
  uploadDriveWorkspaceFile: (parentId) => window.nightwatch.media.uploadDriveWorkspaceFile(parentId),
